...
import org.firstinspires.ftc.teamcode.commands.paths.DuckSideBlue;
...
@Autonomous(name = "BlueBlueBlue")
public class BlueDuckAutoTwo extends CommandOpMode {
                        ...
                        new SelectCommand(new HashMap<Object, Command>() {{
                            put(CapstoneDetector.Placement.RIGHT,
                                    (new InstantCommand(() -> capstoneDetector.getCamera().stopStreaming())
                                            .andThen(new DuckParkBlue(tankDriveSubsystem,
